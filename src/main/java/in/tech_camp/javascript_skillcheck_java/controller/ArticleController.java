...
public class ArticleController {
  ...
  public ResponseEntity saveArticle(@ModelAttribute("articleForm") ArticleForm form){
    ArticleEntity article = new ArticleEntity();
    article.setText(form.getText());
    articleRepository.insert(article);
    ArticleEntity completeArticle = articleRepository.findById(article.getId());
    return ResponseEntity.ok(completeArticle);
  }
}
